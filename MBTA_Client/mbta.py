...
# This is site url for mbta api
url = 'https://api-v3.mbta.com/vehicles'
headers = {'accept': 'text/event-stream', 'x-api-key': 'SET_YOUR_MBTA_ACCESS_KEY_HERE'}
    ...
    if line:
        ...
        if decoded_line.startswith('event:'):
            ...
            try:
                ...
                producer.send("mbta_messsages", key=bytes(str(int(time.time())), encoding='utf-8'), 
